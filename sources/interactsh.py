...
class Interactsh:
    ...
    def register(self) -> None:
        ...
        for server in self.servers:
            try:
                ...
                logger.error(
                    f"Server {server} failed to register, trying the next one: {e}"
                )
                continue
    ...
    def poll(self) -> list:
        ...
        try:
            ...
            logger.error(
                "An error occured with the target, maybe a proxy is blocking you ?"
            )
    ...
    def __parse_log(self, log_entry: dict) -> dict:
        new_log_entry = {
